function myfunc(){
    ...
    if (b1.toLowerCase() == 'o' && b2.toLowerCase() == '0' && b3.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b4.toLowerCase() == 'o' && b5.toLowerCase() == '0' && b6.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b7.toLowerCase() == 'o' && b8.toLowerCase() == '0' && b9.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b1.toLowerCase() == 'o' && b4.toLowerCase() == '0' && b7.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b2.toLowerCase() == 'o' && b5.toLowerCase() == '0' && b8.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b3.toLowerCase() == 'o' && b6.toLowerCase() == '0' && b9.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b1.toLowerCase() == 'o' && b5.toLowerCase() == '0' && b9.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } else if (b3.toLowerCase() == 'o' && b5.toLowerCase() == '0' && b7.toLowerCase() == '0') {
    window.alert('You are a winner');
    reset();
    } 
}
